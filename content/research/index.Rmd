...
We simulated the response of temperature sensors in [the skin](https://doi.org/10.1111/ina.12859){target="_blank"} (known as thermoreceptors) and used machine learning to predict thermal pleasure based on those simulations. This is the first time that thermal pleasure has been modelled using thermoreceptors. Not only do we better understand the neurophysiology of thermal perception, but we can now predict how we experience thermal pleasure in buildings.
